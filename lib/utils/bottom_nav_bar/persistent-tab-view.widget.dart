...
import 'package:spotify_clone_provider/utils/bottom_nav_bar/models/persistent-bottom-nav-bar-styles.widget.dart';

import 'models/nav-bar-padding.model.dart';
import 'models/persistent-bottom-nav-bar.widget.dart';
import 'models/persistent-nav-bar-scaffold.widget.dart';
import 'models/route-settings.model.dart';
import 'models/tab-view.widget.dart';
...
class PersistentTabView extends PersistentTabViewBase {
  ...
  PersistentTabView(this.context,
      ...
      required bool popAllScreenOnTapOfSelectedTab})
      : super(
          key: key,
          context: context,
          screens: screens,
