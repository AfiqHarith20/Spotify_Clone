...
class MainController extends ChangeNotifier {
  ...
  List<dynamic> getRecentPlayed() {
    List<dynamic> data = [];
    var box = Hive.box('Recently Played');
  ...
  void init() async {
    ...
    final recentSongs = getRecentPlayed();
  ...
  void changeIndex(int newIndex, int oldIndex) {
    player.playlist!.audios.insert(
      newIndex,
      player.playlist!.audios.removeAt(oldIndex),
    );
    notifyListeners();
  }
